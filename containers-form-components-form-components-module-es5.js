(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["containers-form-components-form-components-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormComponentsRoutingModule = /** @class */ (function () {
                function FormComponentsRoutingModule() {
                }
                return FormComponentsRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormComponentsComponent = /** @class */ (function () {
                ...
                function FormComponentsComponent(formBuilder) {
                    ...
                    this.subscriptions.push(this.aliasForm.controls.neverAgain.valueChanges.subscribe(function () {
                        if (_this.aliasForm.controls.neverAgain.value) {
                            _this.aliasForm.controls.alias.disable();
                        }
                        else {
                            _this.aliasForm.controls.alias.enable();
                        }
                    }));
                }
                /**
                 * Init the proyect
                 */
                FormComponentsComponent.prototype.ngOnInit = function () {
                    // RADIO BUTTON
                    ...
                    this.cancelAnRequestForm.controls['indAnulacion'].valueChanges.subscribe(function (value) {
                        alert(value);
                    });
                };
                /**
                 ...
                 */
                FormComponentsComponent.prototype.sendForm = function (type) {
                    // if (type === 'setAlias') {
                 ...
                 */
                FormComponentsComponent.prototype.goToIndex = function () {
                    alert('Ir al index');
                    // this.submitForm.emit({
                    //   form: this.aliasForm,
                    //   formName: null
                 ...
                 */
                FormComponentsComponent.prototype.showError = function (formControl) {
                 ...
                 */
                FormComponentsComponent.prototype.getError = function (formControl) {
            ...
            FormComponentsComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=containers-form-components-form-components-module-es5.js.map
//# sourceMappingURL=containers-form-components-form-components-module-es5.js.map